...
export default function DriverPanel() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-safebus-yellow/5 to-white p-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-safebus-yellow/5 to-white">
      {/* Header */}
